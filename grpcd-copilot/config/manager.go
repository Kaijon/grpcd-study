...
// ReadConfig executes readFunc while holding a read lock so callers can safely
// inspect the current configuration without worrying about concurrent writers.
func ReadConfig(readFunc func(Config)) {
	configLock.RLock()
