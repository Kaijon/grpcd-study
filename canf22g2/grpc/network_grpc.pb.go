...
const (
	...
	NetworkInfoService_UpdateIPv6_FullMethodName        = "/canf22g2.grpc.NetworkInfoService/UpdateIPv6"
...
type NetworkInfoServiceClient interface {
	...
	UpdateIPv6(ctx context.Context, in *UpdateIPv6Request, opts ...grpc.CallOption) (*UpdateIPv6Response, error)
...
func (c *networkInfoServiceClient) UpdateIPv6(ctx context.Context, in *UpdateIPv6Request, opts ...grpc.CallOption) (*UpdateIPv6Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateIPv6Response)
	err := c.cc.Invoke(ctx, NetworkInfoService_UpdateIPv6_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NetworkInfoServiceServer interface {
	...
	UpdateIPv6(context.Context, *UpdateIPv6Request) (*UpdateIPv6Response, error)
...
func (UnimplementedNetworkInfoServiceServer) UpdateIPv6(context.Context, *UpdateIPv6Request) (*UpdateIPv6Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateIPv6 not implemented")
}
...
func _NetworkInfoService_UpdateIPv6_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateIPv6Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetworkInfoServiceServer).UpdateIPv6(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NetworkInfoService_UpdateIPv6_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetworkInfoServiceServer).UpdateIPv6(ctx, req.(*UpdateIPv6Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NetworkInfoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateIPv6",
			Handler:    _NetworkInfoService_UpdateIPv6_Handler,
		},
		{
